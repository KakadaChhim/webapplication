        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showService')}}">
              <span class="menu-icon">
                ...
                <span class="menu-title">Show All Services</span>
            </a>
        </li>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('about')}}">
              <span class="menu-icon">
                ...
                <span class="menu-title">Add New About</span>
            </a>
        </li>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showAbout')}}">
              <span class="menu-icon">
                ...
                <span class="menu-title">Show All About</span>
            </a>
        </li>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showCourse')}}">
              <span class="menu-icon">
                ...
                <span class="menu-title">Show All Course</span>
            </a>
        </li>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('team')}}">
              <span class="menu-icon">
                ...
                <span class="menu-title">Add New Team</span>
            </a>
        </li>

        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showTeam')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
                <span class="menu-title">Show All Team</span>
            </a>
        </li>
    </ul>
</nav>
